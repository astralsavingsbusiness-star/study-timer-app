...
server.registerResource(
  ...
  async () => {
    const filePath = join(process.cwd(), 'public', 'study-timer-widget.html');
...
server.registerTool(
  ...
  async (args) => {
    ...
    const durationSeconds = typeof args.durationSeconds === 'number' && args.durationSeconds >= 0
    ...
    const text = mode === 'timer'
        ? (durationSeconds ? 'Here is your ' + durationSeconds + ' second timer.' : 'Here is your timer.')
